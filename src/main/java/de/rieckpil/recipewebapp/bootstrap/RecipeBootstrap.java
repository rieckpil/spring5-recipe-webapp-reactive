package de.rieckpil.recipewebapp.bootstrap;

import de.rieckpil.recipewebapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        log.debug("initialized database with bootstrap recipe");
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), guacRecipe, teapoonUom));
